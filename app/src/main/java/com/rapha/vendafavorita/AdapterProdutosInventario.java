...
//            }
    ...
    class InventarioProdViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private View bt_refresh_item_inventario;
        ...
        public InventarioProdViewHolder(@NonNull View itemView) {
            ...
            bt_refresh_item_inventario = (View) itemView.findViewById(R.id.bt_refresh_item_inventario);

            bt_refresh_item_inventario.setOnClickListener(this);
        ...
        public void onClick(View v) {
            ...
            } else if(v.getId() == R.id.bt_refresh_item_inventario) {
                listener.atualizar(o);
            } else {
