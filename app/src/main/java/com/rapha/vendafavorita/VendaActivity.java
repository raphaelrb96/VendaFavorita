...
import com.rapha.vendafavorita.objects.CarComprasActivyParcelable;
import com.rapha.vendafavorita.objects.CompraFinalizadaParcelable;

import java.util.ArrayList;
import java.util.Date;


public class VendaActivity extends FragmentActivity {
    ...
    private void preencherInterface() {
        ...
        tv_nome_rua_venda.setText(dadosCompra.getAdress() + " - " + dadosCompra.getComplemento() + " numero: " + dadosCompra.getPhoneUser());
    }
